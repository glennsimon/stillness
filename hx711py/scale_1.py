...
print("Tare done! Add weight in the next 5 seconds...")
time.sleep(5)
...
while True:
    try:
        ...
        # val = hx.get_weight(5)
        sum = sum + hx.get_weight(5)
        val = sum / inc
        inc = inc + 1
        # val = hx.read_average(times=100)
        delta_sec = time.monotonic_ns() - now
        print("running avg: " + str(val))
        print(delta_sec)
